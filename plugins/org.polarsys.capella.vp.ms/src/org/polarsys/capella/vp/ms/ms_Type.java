...
public enum ms_Type implements Enumerator {
   ...
   * @ordered
   */
  MIXED(0, "mixed", "mixed"), //$NON-NLS-1$ //$NON-NLS-2$
   ...
   * @ordered
   */
  STATE(1, "state", "state"), //$NON-NLS-1$ //$NON-NLS-2$
   ...
   * @ordered
   */
  MODE(2, "mode", "mode"); //$NON-NLS-1$ //$NON-NLS-2$

  /**
   * The '<em><b>Mixed</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #MIXED
   * @model name="mixed"
   * @generated
  ...
  /**
   * The '<em><b>State</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #STATE
   * @model name="state"
   * @generated
  ...
  /**
   * The '<em><b>Mode</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #MODE
   * @model name="mode"
   * @generated
